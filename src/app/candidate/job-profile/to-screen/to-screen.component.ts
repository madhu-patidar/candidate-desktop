...
import { CandidateService } from '../../my-profile/candidate.service';
import { CANDIDATE_JOB_PROFILE_PATH_LIST } from '../job-profile.constant';

@Component({
  selector: 'app-to-screen',
  templateUrl: './to-screen.component.html',
  styleUrls: ['./to-screen.component.css'],
  providers: [CandidateService]
})
export class ToScreenComponent implements OnInit {
